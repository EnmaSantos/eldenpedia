...
import { ArrowLeft, Save, Swords, X, ArrowRight, Sparkles } from "lucide-react";
import { cn } from "@/lib/utils";
import weaponsData from "@/data/weapons.json";
import { Weapon } from "@/types/weapon";
import { calculateAR } from "@/lib/calculator";
...
export default function WeaponComparisonPage() {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-8 max-w-6xl mx-auto pb-20">
      <div className="mb-6">
        <Link href="/weapons" className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
